...
├── controllers/
│   ├── authController.js   # Logic for users
│   └── reviewController.js # Logic for reviews
├── docs/
│   └── swaggerDef.js    # Centralized Swagger documentation
├── middleware/
│   └── authMiddleware.js # JWT protection & request validation
├── routes/
